...
Pode ser necessário adicionar o \emph{import} manualmente, basta adicionar os dois necessários (\hyperref[code:importTI]{Algoritmo \ref*{code:importTI}}) para esse exemplo antes da declaração da \emph{public class MainActivity ...}.

\begin{listing}[H]
\inputminted[linenos=true,fontsize=\small,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{java}{src/firstapp/10.java}
\caption{\emph{import} para o \emph{TextView} e \emph{Intent}}
\label{code:importTI}
\end{listing}
