...
\paragraph{}Este documento foi baseado no iOS 6.1 e XCode 4.5.
...
UIKit Framework Reference\\ \(http://developer.apple.com/library/ios/\#documentation/uikit/reference/\\UIKit\_Framework/\_index.html\).}
...
\paragraph{}\textit{\textbf{\underline{Dica}}: Lembrando que sempre podemos determinar o layout e a criação dos objetos diretamente no código, sendo o Interface Builder apenas um facilitador. Em diversos casos lidar com o código acaba sendo a melhor opção.}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.5\textheight]{figuras/1/xib.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.7\textheight]{figuras/1/xib_opcoes.png}
...
\paragraph{}No canto inferior esquerdo está presente a seção de \emph{Objetos}, os quais podem ser selecionados e arrastados à tela.
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/1/xib_objetos.png}
...
\paragraph{}No pop-up é possível escolher se é um \texttt{\textbf{IBOutlet}} ou uma \texttt{\textbf{IBAction}}, mas por enquanto criaremos só os \texttt{\textbf{IBOutlets}}. Escolha um nome apropriado ao objeto, que o diferencie mas também deixe claro o seu tipo para facilitar a leitura do código, como \texttt{\textbf{okButton}}.
...
\begin{figure}[H]
  ...
  \caption{IBOutlets: ligação dos objetos com o código}
  \label{fig:a}
\end{figure}
...
\paragraph{}Esta propriedade representa a \emph{Navigation Controller} em si. No arquivo FirstAppAppDelegate.m, deixaremos o primeiro método deste jeito:
...
\paragraph{}Voltando à classe da primeira tela, podemos agora criar um título para a tela, que aparecerá na barra de navegação. No método \texttt{\textbf{viewDidLoad}} adicione o seguinte código.
...
\paragraph{}Podemos agora começar a adicionar funcionalidades com o código. Vamos criar uma \texttt{\textbf{IBAction}} bem simples para testar o comportamento do aplicativo com o simulador. Para isso basta arrastar o botão para o código segurando Control, e escolher a opção \texttt{\textbf{IBAction}}, e criar um nome para ela, como \texttt{\textbf{okTouched}}. A intenção da nossa primeira \texttt{\textbf{IBAction}} é que os textos do botão e do rótulo troquem quando clicarmos no botão.
\paragraph{}Com a \texttt{\textbf{IBAction}} criada, veja que no código de implementação da classe (arquivo .m) já será criado o esqueleto do método que será chamado, onde colocaremos nossa lógica.
...
\section{Configurando uma tela de slide}
...
\paragraph{}\textit{\textbf{\underline{Dica}}: Para informações detalhadas sobre integração com redes sociais veja a documentação oficial da Apple da biblioteca \texttt{\textbf{Social Framework}}:\\
...
\paragraph{}\textit{\textbf{\underline{Dica}}: Acompanhe a documentação oficial da Apple sobre boas práticas para trabalhar com fotos e vídeo através da câmera em:\\
...
\paragraph{}\textit{\textbf{\underline{Dica}}: Entenda melhor como trabalhar com a localização do usuário neste guia oficial da Apple:\\
