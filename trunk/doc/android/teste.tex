...
\begin{listing}
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{xml}{../../src/android/firstapp/1.xml}
...
\begin{listing}[H]
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{xml}{../../src/android/firstapp/2.xml}
...
\begin{listing}
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{xml}{../../src/android/firstapp/3.xml}
...
\begin{listing}
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{java}{../../src/android/firstapp/4.java}
...
\begin{listing}
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{java}{../../src/android/firstapp/4-2.java}
...
\begin{listing}[H]
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{java}{../../src/android/firstapp/5.java}
...
\begin{listing}[H]
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{java}{../../src/android/firstapp/6.java}
...
\begin{listing}[H]
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{java}{../../src/android/firstapp/7.java}
...
\begin{listing}[H]
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{java}{../../src/android/firstapp/8.java}
...
\begin{listing}[H]
\inputminted[linenos=true,frame=lines, framesep=2mm, tabsize=2,numbersep=5pt]{java}{../../src/android/firstapp/9.java}
