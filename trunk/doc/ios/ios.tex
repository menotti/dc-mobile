...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_boas_vindas_xcode.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_2.png}
  \caption{Criação de um novo projeto}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_3.png}
  \caption{Criação de um novo projeto}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.35\textheight]{figuras/caio/tela_novo_projeto_4.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=1]{figuras/caio/tela_opcao_exibicao.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.35\textheight]{figuras/caio/tela_principal_xcode.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.1\textheight]{figuras/caio/tela_principal_xcode_run.png}
  \caption{Classe principal do projeto}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.35 \textheight]{figuras/caio/tela_novo_projeto_5.png}
  \caption{Classe principal do projeto}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.15 \textheight]{figuras/caio/tela_novo_projeto_6.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4 \textheight]{figuras/caio/tela_novo_projeto_7.png}
  \caption{Adicionando uma nova interface ao projeto}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4 \textheight]{figuras/caio/tela_novo_projeto_8.png}
  \caption{Adicionando uma nova interface ao projeto}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4 \textheight]{figuras/caio/tela_novo_projeto_9.png}
  \caption{Adicionando uma nova interface ao projeto}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.35 \textheight]{figuras/caio/tela_novo_projeto_10.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.35\textheight]{figuras/caio/tela_novo_projeto_11.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.20\textheight]{figuras/caio/tela_novo_projeto_12.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.1\textheight]{figuras/caio/tela_novo_projeto_13.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.2\textheight]{figuras/caio/tela_novo_projeto_14.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.2\textheight]{figuras/caio/tela_novo_projeto_15.png}
  \caption{Alterar modo de exibição do \emph{Placeholders}}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_19.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_16.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_17.png}
  \caption{Configurando a tela inicial do aplicativo}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.55\textheight]{figuras/caio/tela_novo_projeto_18.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=1]{figuras/caio/tela_novo_projeto_20.png}
...
\begin{framed}
\paragraph{}\textbf{Dica}: Caso esteja utilizando o MAC OS X em um computador com um teclado padrão Windows, a tecla \textit{Windows }é equivalente a tecla \textit{Comando}.
\end{framed}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.2\textheight]{figuras/caio/tela_novo_projeto_21.png}
  \caption{Adicionando uma \texttt{\textbf{IBAction}} para exibir uma mensagem na tela}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.5\textheight]{figuras/caio/tela_novo_projeto_22.png}
...
\begin{framed}
\paragraph{}\textbf{Dica}: A tecla \textit{Control} é equivalente à tecla textit{Ctrl} esquerda em outros formatos de teclado.
\end{framed}

\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.5\textheight]{figuras/caio/tela_novo_projeto_23.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=1]{figuras/caio/tela_novo_projeto_24.png}
  \caption{Conectando o \emph{button} com a \texttt{\textbf{IBAction}}}
  \label{fig:a}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.55\textheight]{figuras/caio/tela_novo_projeto_25.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.55\textheight]{figuras/caio/tela_novo_projeto_26.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.45\textheight]{figuras/caio/tela_novo_projeto_27.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.2\textheight]{figuras/caio/tela_novo_projeto_28.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.2\textheight]{figuras/caio/tela_novo_projeto_29.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.45\textheight]{figuras/caio/tela_novo_projeto_30.png}
...
\paragraph{}Para chamar uma nova tela é preciso criar uma instância da \emph{View Controller} (uma nova interface) a ser chamada, no caso da SecondScreenViewController (que ainda não criamos), para então jogá-la na pilha com o método de \emph{push}, que recebe como parâmetro a instância criada. Crie um botão na primeira tela do aplicativo (\emph{FirstAppViewController.xib}) com o texto \emph{Ir para tela 2}.

\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.55\textheight]{figuras/caio/tela_novo_projeto_31.png}
  \caption{Primeira tela com o botão de chamada para segunda tela}
  \label{fig:a}
\end{figure}

\paragraph{}Agora precisamos criar a segunda tela que será chamada, clique com direito na pasta do projeto e em \emph{New file}. Selecione \emph{Objective-C class} e clique em \emph{Next}, vamos dar o nome de \emph{SecondScreenViewController} e marcar a opção \emph{Also create a XIB file}.

\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.25\textheight]{figuras/caio/tela_novo_projeto_32.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_33.png}
  \caption{Configuração da segunda tela do aplicativo}
  \label{fig:a}
\end{figure}

\paragraph{}A tela do projeto deve estar como a figura abaixo.

\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_34.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.55\textheight]{figuras/caio/tela_novo_projeto_35.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.35\textheight]{figuras/caio/tela_novo_projeto_36.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.35\textheight]{figuras/caio/tela_novo_projeto_37.png}
...
\paragraph{}Com a segunda tela criada, voltemos para a primeira (\emph{FirstAppViewController.xib}) para configurar o botão \emph{Ir para tela 2}. Para isso vamos criar uma \texttt{\textbf{IBAction}}, segurando a tecla \emph{Ctrl} esquerdo clique no botão e arraste para a parte de código do arquivo \emph{FirstAppViewController.h}.

\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.35\textheight]{figuras/caio/tela_novo_projeto_38.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.2\textheight]{figuras/caio/tela_novo_projeto_39.png}
...
\paragraph{}Com a \texttt{\textbf{IBAction}} criada, vamos para o arquivo \emph{FirstAppViewController.m} onde já foi criado automaticamente o esqueleto dessa ação. Para chamar a segunda tela primeiramente inclua nesse arquivo .m a importação da classe referente à segunda tela:
...
\paragraph{}Em seguida deixe o método da \texttt{\textbf{IBAction}} como abaixo:
...
\paragraph{}Na linha 2 inicializamos a \emph{View Controller} e na linha 6 adicionamos a \emph{View Controller} à pilha da \emph{Navigation Controller}.

\paragraph{}Agora vá até o arquivo .m da segunda tela (\emph{SecondScreenViewController.m}) e deixe o método \emph{- (void)viewDidLoad} da seguinte forma:
...
\paragraph{}O código da linha 4 serve para dar um título para a tela que será exibido na \emph{Navigation controller}.
\paragraph{}Rode o aplicativo para testar a função, quando estiver na tela 2 é possível retornar à tela 1 através da \emph{Navigation controller} no topo da tela.

\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.55\textheight]{figuras/caio/tela_novo_projeto_40.png}
  \caption{Segunda tela do aplicativo}
  \label{fig:a}
\end{figure} 

\paragraph{}Para dar funcionalidade ao botão \emph{Ir para tela 3}, crie a terceira tela com o nome \emph{ThirdScreenViewController}, seguindo o exemplo, e faça a chamada da mesma forma que foi feito na primeira tela. Faça os testes e verifique o funcionamento. É possível retornar às telas anteriores, pois a \emph{Navigation Controller} cria um botão de retorno automaticamente.

\bigskip

\subsection{Trocando informação entre telas}

\paragraph{}Ao inicializarmos uma instância de uma \emph{View Controller}, podemos atribuir valores às suas \emph{Properties} antes de fazer o \emph{push} da tela. Dessa forma bem simples, é possível levar informação de uma tela existente para uma tela nova, podendo exibir ou tratar esses dados convenientemente na \emph{View Controller} da próxima tela. Para exemplificar, vamos criar um campo de texto na segunda tela e exibir o seu conteúdo em um rótulo (\emph{label}) na terceira tela.
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.2\textheight]{figuras/caio/tela_novo_projeto_41.png}
...
\paragraph{}Além da variável NSString é necessário criar o \texttt{\textbf{IBOutlet}} da \emph{label} da tela 3. Dessa forma o valor será passado da tela 2 para a variável NSString e então passado para a label da interface.

\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_45.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.18\textheight]{figuras/caio/tela_novo_projeto_46.png}
  \caption{Configuração do \texttt{\textbf{IBOutlet}} da caixa de texto da tela 3}
  \label{fig:a}
\end{figure} 
 
\paragraph{}Na segunda tela deve ser adicionado um \emph{text} que será utilizado para digitar o texto, em seguida criado um \texttt{\textbf{IBOutlet}} para esse \emph{text}.
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_42.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.18\textheight]{figuras/caio/tela_novo_projeto_43.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.4\textheight]{figuras/caio/tela_novo_projeto_44.png}
  \caption{Tela 2 e seus atributos. Repare nos pontos que definem as ligações dos \texttt{\textbf{IBOutlets}} com a interface.}
  \label{fig:a}
\end{figure}
...
\paragraph{}Além disso, precisamos tratar o conteúdo da variável na classe da terceira tela. Vamos verificar no método \texttt{\textbf{viewDidLoad}} presente no arquivo \emph{ThirdScreenViewController.m} o conteúdo da variável que recebeu o dado da segunda tela.
...
\paragraph{}De uma forma bem simples, verificamos o conteúdo da string recebida na linha 6 e a atribuimos para o conteúdo do rótulo na linha 7 ou 10, de acordo com a condição.
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.55\textheight]{figuras/caio/tela_novo_projeto_47.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.45\textheight]{figuras/caio/tela_novo_projeto_48.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[totalheight=0.55\textheight]{figuras/caio/tela_novo_projeto_49.png}
...
\paragraph{}Adicione também a importação da Tela 3 ao arquivo \emph{SecondScreenViewController.h}:
...
\paragraph{}Na linha 3 chamamos a tela 3 para a \emph{Navigation Controller}, e na linha 6 salvamos a mensagem que escrevemos como conteúdo do campo de texto criado na tela 3, na segunda tela foi criado um \emph{Text field} ligado através de uma \texttt{\textbf{IBOutlet}} chamada de \emph{textoSegundaTela} .
