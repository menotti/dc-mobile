...
\end{minted}
\caption{Definição do título de uma tela}
\end{listing}
...
\paragraph{}\textit{\textbf{\underline{Dica}}: Veja a documentação oficial da Apple sobre o \texttt{\textbf{Core Motion Framework}}:\\
