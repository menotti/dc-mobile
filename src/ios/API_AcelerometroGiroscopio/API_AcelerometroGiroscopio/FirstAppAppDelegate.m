...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ApiAcelerometroGiroscopioViewController *viewController = [[ApiAcelerometroGiroscopioViewController alloc] initWithNibName:@"ApiAcelerometroGiroscopioViewController" bundle:nil];
